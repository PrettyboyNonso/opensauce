...
const Header = () => {
  ...
  return (
    <header className="flex w-full px-6 py-5 fixed bg-bgColor/50 border-b border-solid top-0 backdrop-blur-sm z-50 items-center">
      <div className="flex items-center flex-shrink-0 flex-grow-0 gap-3 basis-[50%]">
        ...
        <nav className="hidden lg:block">
          <ul className="flex gap-4 items-center font-inter font-semibold mt-1 capitalize text-sm text-textColor">
            ...
            <NavLink to="/components" onClick={() => setSidebar("components")}>
